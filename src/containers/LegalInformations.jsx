    ...
    <section className="container-legal-informations">
        ...
        <h2>Propriétaire du site www.sante-varennes-sur-allier.fr</h2>
            <ul>
                ...
                <li>03150 Varennes-Sur-Allier</li>
                <li>SIRET : 89304640800014</li>
        ...
        <h2>Droites d&apos; auteur</h2>
            <p>
                ...
                de publier, et de communiquer intégralement ou partiellement, sous quelque forme que ce soit, les données, la
                présentation ou l&apos; organisation du site ou les œuvres protégées par le droit d&apos; auteur qui figurent sur le site web
                « www.sante-varennes-sur-allier.fr » sans autorisation écrite particulière et préalable du détenteur du droit d&apos; auteur attaché
        ...
        <h2>Liens hypertexte et responsabilités</h2>
            <p>
                ...
                La création de liens hypertexte vers nos sites est soumise à notre accord préalable. Dans le cas de la création d&apos; un
                lien hypertexte vers nos sites qui n&apos; aurait pas fait l&apos; objet d&apos; un accord préalable, nous nous réservons le droit d&apos; exiger
                à tout moment le retrait dudit lien hypertexte pointant sur nos sites.
       ...
       <h2>Crédits</h2>
            ...
            <ul>
                <li>
                    <a href="https://www.freepik.com/free-photo/doctor-with-stethoscope-hands-hospital-background_1202124.htm">Image by snowing</a> on Freepik
                </li>
                <li>
                    <a href="https://www.freepik.com/free-photo/odenwald-germany-is-pure-nature_13460763.htm#page=2&query=paysage%20vert%20vallon%C3%A9&position=3&from_view=search&track=ais&uuid=c1b82a37-a982-4452-b8b1-8a1eae43ba32">Image by wirestock</a> on Freepik
                </li>
                <li>
                    Image by <a href="https://www.freepik.com/free-photo/front-view-doctor-holding-hearing-aids_32077723.htm#query=appareil%20auditif&position=19&from_view=search&track=ais&uuid=ca2119e1-b2c5-4acc-8643-cafd4d6c5188">Freepik</a>
                </li>
                <li>
                    <a href="https://www.freepik.com/free-photo/closeup-support-hands_2976003.htm">Image by rawpixel.com</a> on Freepik  
                </li>
            </ul>

            <h4>Site développé par Mandy Treizebré </h4>
            <h4> Adresse Mail </h4>
