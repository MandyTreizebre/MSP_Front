...
const Admin = () => {
  ...
  const [numNews, setNumNews] = useState(0) // Ajouté pour le nombre de professionnels de santé
  ...
  // Display Professionals on Admin Page 
  const displayPros = () => {
    setError(null) 
    displayAllProfessionals()
      .then((res) => {
        setProfessionals(res.data.result)
        console.log("res dans le displayPros =>", res.data.result)
  ...
  // Display External Professionals on Admin Page 
  ...
  // Display Health Informations on Admin Page 
  ...
  // Change professional's status on Admin Page 
        ...
        <section className='first-section-admin-panel'>
          ...
          <div id="health-informations" className='container-data-admin'>
            ...
            <div className='action-admin'>
              ...
              <HealthInformationsAdmin healthInformations={healthInformations} />
            {error && <div className="error-message">{error}</div>}
          </div>
